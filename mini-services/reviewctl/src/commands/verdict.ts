 ...
 * - PASS: No P0 findings
 * - INCOMPLETE: Missing required agent reports
 * - INVALID: Reports failed contract validation
...
interface AggregatedResults {
  ...
  topP0Findings: (Finding & { agent: string })[];
  topP1Findings: (Finding & { agent: string })[];
}
