# Agent Handoff Request: pr-test-analyzer

## Run Information
- **Run ID**: run_20260226_61dea96e
- **Branch**: review/main-72cb7b2
- **Base Branch**: main
- **Timestamp**: 2026-02-27T02:34:45.483Z
...
```bash
reviewctl ingest --agent pr-test-analyzer --input <report-file.md>
```

Or pipe directly:

```bash
cat <<'EOF' | reviewctl ingest --agent pr-test-analyzer
# Report: pr-test-analyzer
...your report content...
EOF
```
